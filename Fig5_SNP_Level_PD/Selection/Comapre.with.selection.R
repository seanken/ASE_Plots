...
meta1=qread("/stanley/levin_asap_storage/ssimmons/ClemensUpdated/meta.selection.without.rep.cells.qs")
meta2=qread("/stanley/levin_asap_storage/ssimmons/ClemensUpdated/meta.with.ASEInfo.qs")
...
ggsave("Reads.Per.Cell.Per.Sample.pdf")
qsave(comb,"comb.qs")
...
qsave(dat2,"dat2.qs")
print("Selected")
scdat1=GetSNPs(meta=meta1,genes=genes,snp_list=snps,samp="batchSamp",snp_col="SNP",cbc_col="CBC",cond="case",cellType="MajorCellTypes",bulk=F)
qsave(scdat1,"scdat1.qs")
print("Not Selected")
scdat2=GetSNPs(meta=meta2,genes=genes,snp_list=snps,samp="batchSamp",snp_col="SNP",cbc_col="CBC",cond="case",cellType="MajorCellTypes",bulk=F)
qsave(scdat2,"scdat2.qs")
